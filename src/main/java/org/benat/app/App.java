...
import org.benat.dao.DaoDeporte;
import org.benat.dao.DaoDeportista;
import org.benat.dao.DaoEquipo;
import org.benat.dao.DaoEvento;
import org.benat.dao.DaoOlimpiada;
import org.benat.dao.DaoParticipacion;
import org.benat.db.BBDD;
...
import org.benat.model.ModeloParticipacion;
...
public class App {
    ...
    public static void main(String[] args) {
        ObjectContainer db=new BBDD().getConnection() ;
        Scanner input=new Scanner(System.in);
        ModeloDeporte d=new ModeloDeporte();
        File f=null;
        try {
            f = new File(d.getClass().getResource("/athlete_events-sort.csv").toURI());
    ...
    private static void aniadirParticipacion(ObjectContainer db, Scanner input) {
        ...
        if(eventos.size()==0) {
            ...
            DaoParticipacion.insertar(new ModeloParticipacion(deportista, evento, new ModeloEquipo("Chicago me limpio", "CHL"), 0, temporada), db);
        }
    }
